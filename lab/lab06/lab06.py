...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        # record the change of the transaction
        before = self.balance - amount 
        after = self.balance 

        #create the transaction for self.transactions
